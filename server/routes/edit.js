...
route.post('/surname', UserLoggin, async (req, res) => {
    ...
    if (surname) {
        try {
            ...
            let updateUsername = 'UPDATE royalreality.rrt_accounts SET surname = ?  WHERE email = ?';
...
route.post('/username', UserLoggin, async (req, res) => {
    ...
    if (username) {
        try {
            const userData = req.app.get('userData');
            let updateUsername = 'UPDATE royalreality.rrt_accounts SET username = ?  WHERE email = ?';
...
route.post('/other', UserLoggin, async (req, res) => {
    ...
    if (othername) {
        try {
            const userData = req.app.get('userData');
            let updateUsername = 'UPDATE royalreality.rrt_accounts SET othername = ?  WHERE email = ?';
...
route.post('/phone_number', UserLoggin, async (req, res) => {
    ...
    if (phone_number) {
        try {
            const userData = req.app.get('userData');
            let updateUsername = 'UPDATE royalreality.rrt_accounts SET phone_number = ?  WHERE email = ?';
...
route.post('/address', UserLoggin, async (req, res) => {
    ...
    if (address) {
        try {
            const userData = req.app.get('userData');
            let updateUsername = 'UPDATE royalreality.rrt_accounts SET address = ?  WHERE email = ?';
...
route.post('/password', UserLoggin, async (req, res) => {
    ...
    if (password) {
        try {
            const userData = req.app.get('userData');
            let updateUsername = 'UPDATE royalreality.rrt_accounts SET password = ?  WHERE email = ?';
